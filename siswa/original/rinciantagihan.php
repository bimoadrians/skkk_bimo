...
if (!isset($_SESSION['logged_in']) || !$_SESSION['logged_in']) {
	...
	for($i = 1; $i <= $bulantagihan; $i++) {
		...
		$t .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$i as besartagihan, b.by$i as tunggakan, $i as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.tunggakan=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan='1' and b.nis='" . $id_key . "' UNION ALL ";
		
		$s .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$i as besartagihan, b.by$i as tunggakan, $i as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.spp=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan='1' and b.nis='" . $id_key . "' UNION ALL ";
		
		$p .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$i as besartagihan, b.by$i as tunggakan, $i as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.pangkal=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan='1' and b.nis='" . $id_key . "' UNION ALL ";		
		
		$k .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$i as besartagihan, b.by$i as tunggakan, $i as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.kegiatan=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan='1' and b.nis='" . $id_key . "' UNION ALL ";		
		
		$l .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$i as besartagihan, b.by$i as tunggakan, $i as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.lainlain=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan='1' and b.nis='" . $id_key . "' UNION ALL ";				
	}
	
	for ($y = 1; $y <= 12; $y++) {
		$y1 .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$y as besartagihan, b.by$y as tunggakan, $y as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.tunggakan=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan<>'1' and b.nis='" . $id_key . "' UNION ALL ";
		$y2 .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$y as besartagihan, b.by$y as tunggakan, $y as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.spp=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan<>'1' and b.nis='" . $id_key . "' UNION ALL ";
		$y3 .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$y as besartagihan, b.by$y as tunggakan, $y as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.pangkal=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan<>'1' and b.nis='" . $id_key . "' UNION ALL ";
		$y4 .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$y as besartagihan, b.by$y as tunggakan, $y as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.kegiatan=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan<>'1' and b.nis='" . $id_key . "' UNION ALL ";
		$y5 .= "SELECT CONCAT(dp.nama, ' - SIS') as namatagihan, b.tg$y as besartagihan, b.by$y as tunggakan, $y as tg FROM besarjtt b LEFT JOIN datapenerimaan dp ON dp.replid=b.idpenerimaan WHERE dp.aktif=1 and dp.lainlain=1 and dp.idkategori='JTT' and dp.type_pembayaran=1 and dp.tahunberjalan<>'1' and b.nis='" . $id_key . "' UNION ALL ";
	}		
	...
	$query = "SELECT * FROM (select CONCAT(dp.nama,' - SIS') as namatagihan, b.besar as besartagihan, sum(b.jumlah+b.diskon) as tunggakan, '' as tg 
	from besarjtt b 
	...
	UNION ALL
	select CONCAT(dp.nama,' - CS') as namatagihan, b.besar as besartagihan, sum(b.jumlah+b.diskon) as tunggakan, '' as tg
	from besarjttcalon b 
	left join datapenerimaan dp on dp.replid=b.idpenerimaan
	left join jbsakad.calonsiswa c on c.replid=b.idcalon
	where dp.aktif=1 and dp.idkategori='CSWJB' and c.nopendaftaran='" . $nopendaftaran . "' group by b.idpenerimaan
	UNION ALL
