...
if (!isset($_SESSION['logged_in']) || !$_SESSION['logged_in']) {
	...
	$query = "SELECT DISTINCT b.replid AS id, b.besar, b.tg1, b.tg2, b.tg3, b.tg4, b.tg5, b.tg6, b.tg7, b.tg8, b.tg9, b.tg10, b.tg11, b.tg12, b.by1, b.by2, b.by3, b.by4, b.by5, b.by6, b.by7, b.by8, b.by9, b.by10, b.by11, b.by12, b.lunas, b.keterangan, b.jumlah, b.diskon, d.nama, d.type_pembayaran, d.departemen, d.tahun_ajar FROM besarjtt b, datapenerimaan d WHERE b.idpenerimaan = d.replid AND b.nis='" . $id_key . "' AND d.type_pembayaran='0' ORDER BY d.tahun_ajar DESC";
	$response = JalankanSQL("view", $query, 700);
	$kartutagihanbebas = $response;
	
	$query = "SELECT DISTINCT b.replid AS id, b.besar, b.tg1, b.tg2, b.tg3, b.tg4, b.tg5, b.tg6, b.tg7, b.tg8, b.tg9, b.tg10, b.tg11, b.tg12, b.by1, b.by2, b.by3, b.by4, b.by5, b.by6, b.by7, b.by8, b.by9, b.by10, b.by11, b.by12, b.lunas, b.keterangan, b.jumlah, b.diskon, d.nama, d.type_pembayaran, d.departemen, d.tahun_ajar FROM besarjtt b, datapenerimaan d WHERE b.idpenerimaan = d.replid AND b.nis='" . $id_key . "' AND d.type_pembayaran='1' ORDER BY d.tahun_ajar DESC";
	$response = JalankanSQL("view", $query, 700);
				...
				<div class="card-body flex-column align-items-start">
					...
					<div class="card-text">
						<div class="col-auto">
							<?php if ($kartutagihanbebas) { ?>
								...
								<table class="table">
								  ...
								  ?>
									<tr>
										  <th scope="row"><?=$warna . $i?></th>
										  <td><?=$warna . $mydata->nama?></td>
										  <td><?=$warna . FormatRupiah($mydata->besar)?></td>
										  <td><?=$warna . FormatRupiah($mydata->besar-($mydata->jumlah+$mydata->diskon))?></td>
									</tr>										  
								  <? } ?>
								  </tbody>
								</table>									
							...
							<?php if ($kartutagihanbulanan) { ?>
								...
								<table class="table">
								  ...
								  ?>
									<tr>
										  <th scope="row"><?if ($cek == 0) {echo $warna . $i;} ?></th>
										  <td><?=$warna . $mydata->nama. " - " . ShortNameOfMonth($x)?></td>
										  <td><?=$warna . FormatRupiah($array1[$x])?></td>
										  <td><?=$warna . FormatRupiah($array1[$x]-$array2[$x]) ?></td>
									</tr>										  
								  <?
											  $cek = $x;
						...
						<div class="col-auto">
							...
							<a href="prosespembayaran.php?mode=<?=$mode_akses?>&nominalbayar=<?=$totalbebas+$totalbulansekarang?>&pilihbayar=0" class="btn btn-danger"><i class="bi bi-cash"></i> Bayar tagihan</a>
						</div>
					</div>
				</div>
			</div>
