			...
			<main>
				...
				<div class="card card-custom p-2 my-3 rounded-4 shadow-lg">
					<div class="card-body flex-column align-items-center text-center">
						...
						<!-- Gambar Ilustrasi -->
						<img src="../assets/imgs/study.png" alt="Rapor"
							class="img-fluid mb-3" style="max-width: 230px;">

						<!-- Judul -->
						<h5 class="card-title fw-bold text-primary">Halaman Nilai Siswa</h5>

						<!-- Pesan Pemberitahuan -->
						<p class="card-text text-muted px-2">
							Halo <b><?= $nama ?></b>, fitur untuk melihat
							<b>nilai rapor siswa</b> saat ini masih dalam tahap
							<b>pengembangan</b>.
						</p>
						<p class="card-text text-muted">
							Orangtua nantinya dapat memantau perkembangan hasil belajar siswa
							melalui menu ini.
						</p>
