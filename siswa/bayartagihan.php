...
$sqlCariCasis		= "SELECT tds.teks AS nopendaftaran
									...
									AND tds.nis = '{$id_key}'";
$dataCarCasis		= JalankanSQL($perintah, $sqlCariCasis, $limit);
$nopendaftaran	= $dataCarCasis[0]->nopendaftaran;
...
$bulanTahun			= JalankanSQL($perintah, $sqlBulanTahun, $limit);
$bulansekarang	= $bulanTahun[0]->bulan;
$tahunsekarang	= $bulanTahun[0]->tahun;
$bulantagihan		= realMonth($bulanTahun[0]->bulan);
...
$sqlLain							= "SELECT DISTINCT b.replid AS id, b.besar,
												b.tg1, b.tg2, b.tg3, b.tg4, b.tg5, b.tg6,
												b.tg7, b.tg8, b.tg9, b.tg10, b.tg11, b.tg12,
												b.by1, b.by2, b.by3, b.by4, b.by5, b.by6,
												b.by7, b.by8, b.by9, b.by10, b.by11, b.by12,
												...
												ORDER BY d.tahun_ajar DESC";
$dataLain							= JalankanSQL($perintah, $sqlLain, 700);
$kartutagihanbulanan	= $dataLain;
//END CARI LAIN-LAIN
